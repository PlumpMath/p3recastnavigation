...
void NavMeshTesterTool::init(NavMeshType* sample, dtQueryFilter* filter)
{
	m_sample = sample;
...
//
//	imguiIndent();
//	if (imguiCheck("Walk", (m_filter.getIncludeFlags() & NAVMESH_POLYFLAGS_WALK) != 0))
//	{
//		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ NAVMESH_POLYFLAGS_WALK);
//		recalc();
//	}
//	if (imguiCheck("Swim", (m_filter.getIncludeFlags() & NAVMESH_POLYFLAGS_SWIM) != 0))
//	{
//		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ NAVMESH_POLYFLAGS_SWIM);
//		recalc();
//	}
//	if (imguiCheck("Door", (m_filter.getIncludeFlags() & NAVMESH_POLYFLAGS_DOOR) != 0))
//	{
//		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ NAVMESH_POLYFLAGS_DOOR);
//		recalc();
//	}
//	if (imguiCheck("Jump", (m_filter.getIncludeFlags() & NAVMESH_POLYFLAGS_JUMP) != 0))
//	{
//		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ NAVMESH_POLYFLAGS_JUMP);
//		recalc();
//	}
//	imguiUnindent();
//
...
//
//	imguiIndent();
//	if (imguiCheck("Walk", (m_filter.getExcludeFlags() & NAVMESH_POLYFLAGS_WALK) != 0))
//	{
//		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ NAVMESH_POLYFLAGS_WALK);
//		recalc();
//	}
//	if (imguiCheck("Swim", (m_filter.getExcludeFlags() & NAVMESH_POLYFLAGS_SWIM) != 0))
//	{
//		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ NAVMESH_POLYFLAGS_SWIM);
//		recalc();
//	}
//	if (imguiCheck("Door", (m_filter.getExcludeFlags() & NAVMESH_POLYFLAGS_DOOR) != 0))
//	{
//		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ NAVMESH_POLYFLAGS_DOOR);
//		recalc();
//	}
//	if (imguiCheck("Jump", (m_filter.getExcludeFlags() & NAVMESH_POLYFLAGS_JUMP) != 0))
//	{
//		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ NAVMESH_POLYFLAGS_JUMP);
//		recalc();
//	}
//	imguiUnindent();
//
